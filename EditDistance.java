 ...
 * @version (07.12.2024)
 */
public class EditDistance   //LevenshteinDistance
{
    public static int editDistance(String[] dict, boolean ignoreCase, boolean p)
    {
        String A = dict[0];
        ...
        for (int k = 1; k < dict.length; k++)
        {
            ...
            if (p) Print.p(D);
            if (p) System.out.println("min="+minimum+" now="+D[lenA][lenB]+" k="+k+" index="+index);
